...
export interface Movie {
    ...
    horizontal_poster?: DirectusFile | string | null;
    backdrop?: DirectusFile | string | null;
    title_image?: DirectusFile | string | null;
...
export interface TopMovies {
    ...
    id: number;
    date_updated?: string | null;
    movies?: TopMoviesMovy[] | string[];
}

export interface TopMoviesMovy {
    /** @primaryKey */
    id: number;
    top_movies_id?: TopMovies | string | null;
    item?: Movie | string | null;
...
export interface Schema {
    ...
    top_movies_movies: TopMoviesMovy[];
...
export enum CollectionNames {
    ...
    top_movies_movies = 'top_movies_movies',
